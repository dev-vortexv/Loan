...
const AddExpansesCategory = (props) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      handleClose();
      setEditExpanseData('');
      editExpanseData ? null : toast.success('Expense Category Add successfully');
      resetForm();
    }
  });
  ...
  return (
    <div>
      <Dialog open={open} aria-labelledby="scroll-dialog-title" aria-describedby="scroll-dialog-description">
        ...
        >
          <Typography variant="h6"> {editExpanseData ? 'Edit Expense Category' : 'Create Expense Category'} </Typography>
          <Typography>
