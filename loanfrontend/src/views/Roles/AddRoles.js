...
const AddRoles = (props) => {
  ...
  // -----------   initialValues
  const initialValues = {
    roleType: editRolesData ? editRolesData.roleType : '',
                ...
                <Grid item xs={12} sm={6} md={4}>
                  ...
                  <FormControl fullWidth>
                    <Select
                      ...
                      label=""
                      size="small"
                      value={formik.values.roleType || null}
                      onChange={formik.handleChange}
                      error={formik.touched.roleType && Boolean(formik.errors.roleType)}
                    >
                      <MenuItem value="borrower">Borrower</MenuItem>
                      <MenuItem value="loanAgent">loan Agent</MenuItem>
                    </Select>
                    <FormHelperText error={formik.touched.roleType && Boolean(formik.errors.roleType)}>
